...
// When do they need to be reset or updated? When the clear button is clicked or if any of the other options are selected.
...
const dayButtons = [monday, tuesday, wednesday, thursday, friday];
